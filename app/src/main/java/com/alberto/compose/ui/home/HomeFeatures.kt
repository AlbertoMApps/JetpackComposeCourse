...
import com.alberto.compose.base.SimpleUserInput
...
fun SleepSearchContent(onPeopleChanged: (Int) -> Unit) {
    CraneSearch {
        ...
        DatesUserInput()
        Spacer(Modifier.height(8.dp))
        SimpleUserInput(caption = "Select Location", vectorImageId = R.drawable.avatar_1)
    }
}
...
fun EatSearchContent(onPeopleChanged: (Int) -> Unit) {
    CraneSearch {
        ...
        DatesUserInput()
        Spacer(Modifier.height(8.dp))
        SimpleUserInput(caption = "Select Time", vectorImageId = R.drawable.paris_1)
        Spacer(Modifier.height(8.dp))
        SimpleUserInput(caption = "Select Location", vectorImageId = R.drawable.avatar_6)
    }
}
